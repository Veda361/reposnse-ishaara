...
export class AdminController {
    ...
    try {
      ...
      if (!survey) {
        return sendError({
          ...
          statusCode: 404,
          code: "NOT_FOUND",
          message: `Survey response with ID ${id} was not found`,
        });
      }
   ...
   */
  async deleteSurveyById(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
   ...
   */
  async exportSurveysCsv(req: Request, res: Response, next: NextFunction) {
    try {
